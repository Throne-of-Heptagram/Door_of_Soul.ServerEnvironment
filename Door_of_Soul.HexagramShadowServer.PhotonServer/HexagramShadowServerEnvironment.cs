...
{
    class HexagramShadowServerEnvironment : ServerEnvironment.ServerEnvironment
    {
        ...
        public override bool SetupLog(out string errorMessage)
        {
            ...
            ShadowHexagramEntranceFactory.Instance.OnSubjectAdded += LogEntranceConnected;
            ShadowHexagramEntranceFactory.Instance.OnSubjectRemoved += LogEntranceDisconnected;
        ...
        {
            ServerInitializer.Initialize(new HexagramShadowServerInitializer());
        ...
        private void LogEntranceDisconnected(ShadowHexagramEntrance entrance)
        {
            HexagramShadowServerApplication.Log.Info($"Entrance: {entrance} disconnected");
        }

        private void LogEntranceConnected(ShadowHexagramEntrance entrance)
        {
