...
namespace Door_of_Soul.HexagramWillServer.PhotonServer
{
    public class WillPeer : InboundS2SPeer
    {
        ...
        public WillPeer(InitRequest initRequest) : base(initRequest)
        {
            ...
            if (WillHexagramEntranceFactory.Instance.CreateEntrance(SendEvent, SendOperationResponse, out entrance))
            {
                Entrance = entrance;
            }
            else
        ...
        protected override void OnOperationRequest(OperationRequest operationRequest, SendParameters sendParameters)
        {
            ...
            string errorMessage;
            if (!EntranceCommunicationService<WillEventCode, WillOperationCode>.Instance.HandleOperationRequest(Entrance, operationCode, parameters, out errorMessage))
            {
