...
{
    class HexagramEternityServerEnvironment : ServerEnvironment.ServerEnvironment
    {
        ...
        public override bool SetupLog(out string errorMessage)
        {
            ...
            EternityHexagramEntranceFactory.Instance.OnSubjectAdded += LogEntranceConnected;
            EternityHexagramEntranceFactory.Instance.OnSubjectRemoved += LogEntranceDisconnected;
        ...
        {
            ServerInitializer.Initialize(new HexagramEternityServerInitializer());
        ...
        private void LogEntranceDisconnected(EternityHexagramEntrance entrance)
        {
            HexagramEternityServerApplication.Log.Info($"Entrance: {entrance} disconnected");
        }

        private void LogEntranceConnected(EternityHexagramEntrance entrance)
        {
            HexagramEternityServerApplication.Log.Info($"Entrance: {entrance} connected");
        }
