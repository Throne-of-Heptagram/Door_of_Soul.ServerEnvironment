...
namespace Door_of_Soul.HexagramInfiniteServer.PhotonServer
{
    class HexagramInfiniteServerEnvironment : ServerEnvironment.ServerEnvironment
    {
        ...
        public override bool SetupLog(out string errorMessage)
        {
            ...
            InfiniteHexagramEntranceFactory.Instance.OnSubjectAdded += LogEntranceConnected;
            InfiniteHexagramEntranceFactory.Instance.OnSubjectRemoved += LogEntranceDisconnected;
        ...
        {
            ServerInitializer.Initialize(new HexagramInfiniteServerInitializer());
        ...
        private void LogEntranceDisconnected(InfiniteHexagramEntrance entrance)
        {
            HexagramInfiniteServerApplication.Log.Info($"Entrance: {entrance} disconnected");
        }

        private void LogEntranceConnected(InfiniteHexagramEntrance entrance)
        {
            HexagramInfiniteServerApplication.Log.Info($"Entrance: {entrance} connected");
        }
