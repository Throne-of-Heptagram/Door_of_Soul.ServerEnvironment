...
{
    class HexagramLoveServerEnvironment : ServerEnvironment.ServerEnvironment
    {
        ...
        public override bool SetupLog(out string errorMessage)
        {
            ...
            LoveHexagramEntranceFactory.Instance.OnSubjectAdded += LogEntranceConnected;
            LoveHexagramEntranceFactory.Instance.OnSubjectRemoved += LogEntranceDisconnected;
        ...
        {
            ServerInitializer.Initialize(new HexagramLoveServerInitializer());
        ...
        private void LogEntranceDisconnected(LoveHexagramEntrance entrance)
        {
            HexagramLoveServerApplication.Log.Info($"Entrance: {entrance} disconnected");
        }

        private void LogEntranceConnected(LoveHexagramEntrance entrance)
        {
