...
namespace Door_of_Soul.HexagramDestinyServer.PhotonServer
{
    public class DestinyPeer : InboundS2SPeer
    {
        ...
        protected override void OnOperationRequest(OperationRequest operationRequest, SendParameters sendParameters)
        {
            ...
            string errorMessage;
            if (!EntranceCommunicationService<DestinyEventCode, DestinyOperationCode>.Instance.HandleOperationRequest(Entrance, operationCode, parameters, out errorMessage))
            {
