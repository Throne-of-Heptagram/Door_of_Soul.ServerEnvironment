...
namespace Door_of_Soul.HexagramLifeServer.PhotonServer
{
    public class LifePeer : InboundS2SPeer
    {
        ...
        public LifePeer(InitRequest initRequest) : base(initRequest)
        {
            ...
            if (LifeHexagramEntranceFactory.Instance.CreateEntrance(SendEvent, SendOperationResponse, out entrance))
            {
                Entrance = entrance;
            }
            else
        ...
        protected override void OnOperationRequest(OperationRequest operationRequest, SendParameters sendParameters)
        {
            ...
            string errorMessage;
            if (!EntranceCommunicationService<LifeEventCode, LifeOperationCode>.Instance.HandleOperationRequest(Entrance, operationCode, parameters, out errorMessage))
            {
